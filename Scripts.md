...
/*triviacommands: function () {
                ...
                rules: function () {
                    var t = new Templater(servername + ' Da Rulez');
                    ...
                    t.register("<b>14</b>) Do not attempt to ignore server authority. Doing so will result in punishment.");
                    t.register("<b>15</b>) Please try to be intelligent or at least somewhat intelligent. In short, don't be an idiot. No one likes this.");
                    ...
                    t.register("The server authority <u>do not</u> have to apply these rules, to an extent. They are authority members. They should know how to act.");
